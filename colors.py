#Organisatie van een ruwe datastring
...
#------------------------------------------------
#Splits datapunten bij de comma
daily_sales_replaced = daily_sales.replace(";,;", ":")
daily_transactions = daily_sales_replaced.split(",")

#Splits datapunten in onderlinge groepen
...
#Verdeling datapunten in aparte lijst per soort
customers = []
sales = []
thread_sold = []
...
#Berekenen totale waarde verkoop
total_sales = 0

for item in sales:
  total_sales += float(item.strip("$"))
  
#Loskoppelen kleuren van &
thread_sold_split = []
...
#Resultaatstring die per kleur het aantal weergeeft
